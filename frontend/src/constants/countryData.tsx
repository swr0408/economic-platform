    ...
    categories: [
      {
        ...
        indicators: [
          ...
          { code: 'fed-rate-cuts', name: 'Fed利上げ・利下げ期待', visibility: 'special' },
      ...
      },
      {
        ...
        indicators: [
          ...
          { code: 'domestic-private-final-demand', name: '国内民間最終需要（除くSW・PC投資）' },
      ...
      },
      {
        ...
        indicators: [
          ...
          { code: 'workers-by-place-of-birth', name: '出生地別労働者数' },
      ...
      },
      {
        ...
        indicators: [
          ...
          { code: 'used-car-prices', name: '中古車価格' },
          { code: 'median-cpi', name: 'Median CPI / 16% Trimmed Mean' },
          { code: 'pce-deflator', name: 'PCEデフレーター' },
          { code: 'supply-and-demand-driven-pce-inflation', name: 'PCE需給分解' },
          { code: 'trimmed-mean-pce', name: 'Trimmed Mean PCE' },
          { code: 'nfib-price-plans', name: 'NFIB価格引き上げ計画' },
    ...
    categories: [
      {
        ...
        indicators: [
          ...
          { code: 'boj-rate-cuts', name: 'BOJ利上げ・利下げ期待', visibility: 'special' },
      ...
      },
      {
        ...
        indicators: [
          ...
          { code: 'reuters-tankan', name: 'ロイター短観' },
          { code: 'pmi', name: 'PMI' },
      ...
      },
      {
        ...
        indicators: [
          ...
          { code: 'unemployment', name: '失業率' },
          { code: 'job-offers-ratio', name: '有効求人倍率' },
      ...
      },
      {
        ...
        indicators: [
          ...
          { code: 'price-di-spread', name: '価格DIスプレッド' },
          { code: 'inflation-outlook', name: '企業の物価見通し' },
    ...
    categories: [
      {
        ...
        indicators: [
          ...
          { code: 'boe-rate-cuts', name: 'BOE利上げ・利下げ期待', visibility: 'special' },
      ...
      },
      {
        ...
        indicators: [
          ...
          { code: 'uk-productivity', name: '労働生産性' },
          { code: 'uk-unit-labour-costs', name: '労働コスト指数' },
    ...
    categories: [
      ...
      },
      {
        ...
        indicators: [
          ...
          { code: 'caixin-pmi', name: 'RatingDog中国PMI（旧Caixin PMI）' },
      ...
      },
      {
        ...
        indicators: [
          { code: 'cpi', name: 'CPI' },
          { code: 'ppi', name: 'PPI' },
          { code: 'export-prices', name: '輸出物価指数' },
        ],
      },
      {
        code: 'housing',
    ...
    categories: [
      {
        ...
        indicators: [
          ...
          { code: 'monetary-base', name: 'マネタリーベース' },
          { code: 'monetary-aggregate-m2', name: '貨幣総量M2' },
        ],
      },
      {
        code: 'economy',
        ...
        indicators: [
          ...
          { code: 'ch-pmi', name: 'PMI（購買担当者景気指数）' },
