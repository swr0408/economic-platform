...
interface BocRateCutsExpectationChartProps {
  title?: string
}
          ...
          <div style={{ textAlign: 'center' }}>
            ...
            {data?.yearend_url ? (
              <Image
                ...
                src={`${API_BASE_URL}/api/canada/boc-rate-cuts-screenshot/yearend?t=${imageKey}`}
                alt="BOC Yearend Rate Expectations"
          ...
          <div style={{ textAlign: 'center' }}>
            ...
            {data?.rate_cuts_url ? (
              <Image
                ...
                src={`${API_BASE_URL}/api/canada/boc-rate-cuts-screenshot/rate-cuts?t=${imageKey}`}
                alt="BOC Rate Cuts Expectations"
                style={{ maxWidth: '100%', height: 'auto' }}
                preview={true}
                placeholder={
                  <div style={{ padding: '40px', background: '#f5f5f5' }}>
