          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 16, flexWrap: 'wrap' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
              ...
              <span style={{ fontSize: 16, fontWeight: 'bold', color: viewMode === 'yoy' ? COLORS.yoy : COLORS.mom }}>
                {(viewMode === 'yoy' ? latestData?.yoy : latestData?.mom)?.toFixed(1) ?? '-'}%
              </span>
            </div>
          </div>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
                      ...
                      <Tooltip title="比較ページを開く">
                        <Button
                          ...
                          onClick={() => window.open(`/compare?s=${viewMode === 'yoy' ? 'japan_tertiary_industry_yoy' : 'japan_tertiary_industry_mom'}`, '_blank')}
                        >
                          データ比較
                        </Button>
                      </Tooltip>
