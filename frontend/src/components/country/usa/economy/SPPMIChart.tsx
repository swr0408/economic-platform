...
import type { SPPMIData } from '../../../../hooks/useDashboardData'

// 共通モジュールのインポート
import { CHART_COLORS, LATEST_VALUE_BOX_STYLE } from '../common/chartConstants'
import {
  usePeriodFiltering,
  useHiddenSeries,
  type PeriodType,
        ...
        <Tabs
          ...
          items={[
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
                    ...
                    <Tooltip title="比較ページを開く（S&P PMI）">
                      <Button
                        ...
                        onClick={() => window.open('/compare?s=sp_manufacturing_pmi&s=sp_services_pmi&s=sp_composite_pmi', '_blank')}
                      >
                        データ比較
                      </Button>
                    </Tooltip>
            ...
            },
            {
              ...
              label: 'マーケットインパクト',
              children: (
                <MarketImpactTab indicatorId="sp_manufacturing_pmi" />
              ),
            },
          ]}
        />
