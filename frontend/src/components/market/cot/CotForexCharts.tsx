...
export default function CotForexCharts() {
  return (
    <div className="country-chart-stack">
      ...
      <LazyChart id="cot-usd-index"><CftcPositioningChart asset="usd_index" assetLabel="ドルインデックス" reportType="tff" compareId="cftc_usd_index" /></LazyChart>
