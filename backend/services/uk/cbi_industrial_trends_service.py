"""
CBI製造業受注指数サービス
DBからCBI Industrial Trends Ordersデータを取得

指標:
- CBI Industrial Trends Orders（製造業受注指数）
...
DATA_CACHE_FILE = CACHE_DIR / "cbi_industrial_trends_cache.json"


class CBIIndustrialTrendsService:
    """CBI製造業受注指数サービス"""

    DATA_CACHE_KEY = "uk:cbi_industrial_trends:data"
    ECONALPHA_ID = "cbi_industrial_trends"

    # FMPカレンダー検索パターン
    FMP_EVENT_PATTERNS = ["CBI Industrial Trends Orders"]

    def __init__(self):
        pass

    def get_cbi_industrial_trends_data(self, force_refresh: bool = False) -> Dict[str, Any]:
        """CBI製造業受注指数データを取得"""
        # 次回発表日を取得
    ...
    def _get_next_release(self) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            print(f"[CBI Industrial Trends] Error getting next release: {e}")
            return None
    ...
    def _load_from_db(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            with SessionLocal() as session:
                ...
                print(f"[CBI Industrial Trends] Loaded {len(result)} records from DB")
                return result

        except Exception as e:
            print(f"[CBI Industrial Trends] Error loading from DB: {e}")
            import traceback
            traceback.print_exc()
            return []
            ...
            try:
                ...
                for pattern in self.FMP_EVENT_PATTERNS:
                    if should_refresh_by_pattern(pattern, last_updated_str, country="GB"):
                        print(f"[CBI Industrial Trends] FMP pattern '{pattern}' indicates refresh needed")
                        return True
            except Exception as e:
                print(f"[CBI Industrial Trends] Error checking FMP refresh: {e}")

            return False

        except Exception as e:
            print(f"[CBI Industrial Trends] Error in should_refresh: {e}")
            return True
    ...
    def _load_file_cache(self) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            print(f"[CBI Industrial Trends] Failed to load file cache: {e}")
            return None
    ...
    def _save_file_cache(self, data: Dict[str, Any]) -> None:
        ...
        try:
            ...
            print(f"[CBI Industrial Trends] Failed to save file cache: {e}")
    ...
    def get_cache_status(self) -> Dict[str, Any]:
        ...
        return {
            "indicator": "CBI Industrial Trends Orders",
            "source": "Database (FMP)",
...
# シングルトンインスタンス
cbi_industrial_trends_service = CBIIndustrialTrendsService()
