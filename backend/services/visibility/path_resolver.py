...
_SCREENSHOT_PATTERNS: list[tuple[str, str]] = [
    ...
    ("fed_rate_cuts", "screenshot:usa_fed_rate_cuts_expectation"),
    ("fed-rate-cuts", "screenshot:usa_fed_rate_cuts_expectation"),
    ("boe_rate_cuts", "screenshot:uk_boe_rate_cuts_expectation"),
    ("boe-rate-cuts", "screenshot:uk_boe_rate_cuts_expectation"),
    ("boj_rate_cuts", "screenshot:jp_boj_rate_cuts_expectation"),
    ("boj-rate-cuts", "screenshot:jp_boj_rate_cuts_expectation"),
