...
class PCEService:
            ...
            if cached_data:
                ...
                if last_updated_str and not self._should_refresh(last_updated_str):
                    return {
                        ...
                        "next_release": get_next_release_from_fmp('pce_mom'),
                        "cached": True,
                        "source": "redis",
    ...
    def _fetch_from_api(self, start_date: Optional[str] = None) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            # 名目個人消費支出
            nominal_raw = self._fetch_series(PCE_SERIES_ID, start_date)
            # 実質個人消費支出
            real_raw = self._fetch_series(PCEC96_SERIES_ID, start_date)
