-- ドイツ失業率の指標マッピング追加
-- germany_unemployment を登録
-- FMPイベント名: Unemployment Rate
-- country: DE

INSERT INTO indicator_event_mapping (econalpha_id, econalpha_name, country, frequency, fmp_event_patterns)
VALUES
    ('germany_unemployment', '失業率（ドイツ）', 'DE', 'monthly', ARRAY['Unemployment Rate'])
...
WHERE econalpha_id = 'germany_unemployment';
