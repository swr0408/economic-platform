"""
日銀 GDPギャップ API Router
日銀GDPギャップ APIエンドポイント
"""
from fastapi import APIRouter, Query

try:
    from backend.services.japan.boj_gdp_gap_service import boj_gdp_gap_service
except ImportError:
    from services.japan.boj_gdp_gap_service import boj_gdp_gap_service

router = APIRouter(prefix="/api/japan/boj-gdp-gap", tags=["Japan Price"])
...
def get_boj_gdp_gap_data(
    ...
    """
    return boj_gdp_gap_service.get_data(force_refresh=force_refresh)
