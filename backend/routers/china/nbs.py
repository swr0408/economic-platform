...
def invalidate_cpi_cache() -> Dict[str, Any]:
    """CPIのキャッシュを無効化"""
...
def get_commercial_residential_sales(
    force_refresh: bool = Query(False, description="強制的にデータを再取得")
) -> Dict[str, Any]:
...
def get_commercial_residential_sales_cache_status() -> Dict[str, Any]:
    """商業住宅販売のキャッシュ状態を返す"""
    return cn_commercial_residential_sales_service.get_cache_status()


@router.delete("/commercial-residential-sales/cache")
def invalidate_commercial_residential_sales_cache() -> Dict[str, Any]:
    """商業住宅販売のキャッシュを無効化"""
...
def get_house_price_index_cache_status() -> Dict[str, Any]:
    """住宅価格指数のキャッシュ状態を返す"""
    return cn_house_price_index_service.get_cache_status()


@router.delete("/house-price-index/cache")
def invalidate_house_price_index_cache() -> Dict[str, Any]:
    """住宅価格指数のキャッシュを無効化"""
...
def invalidate_retail_sales_cache() -> Dict[str, Any]:
    """小売売上高のキャッシュを無効化"""
...
def invalidate_ppi_cache() -> Dict[str, Any]:
    """PPIのキャッシュを無効化"""
...
def invalidate_unemployment_rate_cache() -> Dict[str, Any]:
    """失業率のキャッシュを無効化"""
...
def invalidate_gdp_growth_rate_cache() -> Dict[str, Any]:
    """GDP成長率のキャッシュを無効化"""
...
def get_industrial_production_cache_status() -> Dict[str, Any]:
    """鉱工業生産のキャッシュ状態を返す"""
    return cn_industrial_production_service.get_cache_status()


@router.delete("/industrial-production/cache")
def invalidate_industrial_production_cache() -> Dict[str, Any]:
    """鉱工業生産のキャッシュを無効化"""
...
def get_fixed_asset_investment_cache_status() -> Dict[str, Any]:
    """固定資産投資のキャッシュ状態を返す"""
    return cn_fixed_asset_investment_service.get_cache_status()


@router.delete("/fixed-asset-investment/cache")
def invalidate_fixed_asset_investment_cache() -> Dict[str, Any]:
    """固定資産投資のキャッシュを無効化"""
...
def get_beijing_pm25_cache_status() -> Dict[str, Any]:
    """北京PM2.5のキャッシュ状態を返す"""
    return cn_beijing_pm25_service.get_cache_status()


@router.delete("/beijing-pm25/cache")
def invalidate_beijing_pm25_cache() -> Dict[str, Any]:
    """北京PM2.5のキャッシュを無効化"""
...
def invalidate_trade_balance_cache() -> Dict[str, Any]:
    """貿易収支のキャッシュを無効化"""
...
def get_integrated_circuit_manufacturing(
    force_refresh: bool = Query(False, description="強制的にデータを再取得")
) -> Dict[str, Any]:
...
def get_integrated_circuit_manufacturing_cache_status() -> Dict[str, Any]:
    """集積回路生産のキャッシュ状態を返す"""
    return cn_integrated_circuit_manufacturing_service.get_cache_status()


@router.delete("/integrated-circuit-manufacturing/cache")
def invalidate_integrated_circuit_manufacturing_cache() -> Dict[str, Any]:
    """集積回路生産のキャッシュを無効化"""
...
def get_electronics_stock_cache_status() -> Dict[str, Any]:
    """電気機器在庫のキャッシュ状態を返す"""
    return cn_electronics_stock_service.get_cache_status()


@router.delete("/electronics-stock/cache")
def invalidate_electronics_stock_cache() -> Dict[str, Any]:
    """電気機器在庫のキャッシュを無効化"""
