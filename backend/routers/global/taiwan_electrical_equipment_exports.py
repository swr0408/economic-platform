...
@router.get("")
def get_taiwan_electrical_equipment_exports(
...
@router.get("/cache")
def get_taiwan_electrical_equipment_exports_cache_status() -> Dict[str, Any]:
    """台湾電気機器輸出のキャッシュ状態を取得"""
    return taiwan_electrical_equipment_exports_service.get_cache_status()


@router.delete("/cache")
def invalidate_taiwan_electrical_equipment_exports_cache() -> Dict[str, Any]:
    """台湾電気機器輸出のキャッシュを無効化"""
